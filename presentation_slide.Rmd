...
## Introduction
Objective: Finding out the relationship between reviewers’ comments and price regarding to different room type and neighborhood in Amsterdam. (All prices in this project are assumed in the same currency and the same unit.)
